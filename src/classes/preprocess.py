...
class Preprocess:
    ...
    @staticmethod
    def preprocess_ground_truth(video_directory: str, trim_list_file: str, output_shape: tuple, output_file: str):
        try:
            """
            ...
            print(f"{__class__.__name__} -- {traceback.format_exc()} -- Error file not found: {trim_list_file}")
